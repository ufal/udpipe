...
#tar xf ud-treebanks-v2.10.tgz
rm ud-treebanks-v2.10.tgz
for tb in ud-treebanks-v2.10/*/*-ud-train.conllu; do
  dir=`dirname $tb`
  ...
  case $long_name in
    UD_Arabic-NYUAD|UD_English-ESL|UD_English-GUMReddit|UD_French-FTB|UD_Hindi_English-HIENCS|UD_Japanese-BCCWJ|UD_Japanese-BCCWJLUW) echo Skipping treebank $long_name without forms; continue;;
  esac
