  ...
  <div class="panel-body">
    ...
    <div class="form-horizontal">
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <label class="radio-inline"><input name="family" type="radio" value="-ud-2.3-" onchange="updateModels()" checked />UD 2.3 (<a href="http://ufal.mff.cuni.cz/udpipe/users-manual#universal_dependencies_23_models">description</a>)</label>
