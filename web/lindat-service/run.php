  ...
  <div class="panel-body">
    ...
    <div class="form-horizontal">
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <label class="radio-inline"><input name="family" type="radio" value="-ud-2.4-" onchange="updateModels()" checked />UD 2.4 (<a href="http://ufal.mff.cuni.cz/udpipe/models#universal_dependencies_24_models">description</a>)</label>
          <label class="radio-inline"><input name="family" type="radio" value="-ud-2.3-" onchange="updateModels()" />UD 2.3 (<a href="http://ufal.mff.cuni.cz/udpipe/models#universal_dependencies_23_models">description</a>)</label>
