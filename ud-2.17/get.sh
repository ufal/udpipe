...
wget https://lindat.mff.cuni.cz/repository//bitstream/handle/11234/1-6036/ud-treebanks-v2.17.tgz
exit
tar xf ud-treebanks-v2.17.tgz
rm ud-treebanks-v2.17.tgz

for tb in ud-treebanks-v2.17/*/*-ud-train.conllu; do
  dir=`dirname $tb`
